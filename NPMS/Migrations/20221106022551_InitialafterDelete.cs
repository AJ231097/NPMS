...
{
    public partial class InitialafterDelete : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParkDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PassName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PassPrice = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_Carts_CartOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_CartOrderId",
                table: "OrderDetails",
                column: "CartOrderId");
        }
