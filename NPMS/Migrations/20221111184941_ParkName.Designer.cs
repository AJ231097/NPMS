...
{
    [DbContext(typeof(NPMSContext))]
    [Migration("20221111184941_ParkName")]
    partial class ParkName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NPMS.Models.Careers", b =>
                {
                    ...
                    b.Property<string>("CareerPlace")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CareerRecruiter")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("NPMS.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("NPMS.Models.Events", b =>
                {
            ...
            modelBuilder.Entity("NPMS.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NPMS.Models.Parks", b =>
                {
            ...
            modelBuilder.Entity("NPMS.Models.Passes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NPMS.Models.Reservations", b =>
                {
                    b.Property<Guid>("Rid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NPMS.Models.OrderDetails", b =>
                {
                    b.HasOne("NPMS.Models.Cart", null)
